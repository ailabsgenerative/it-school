---
title: Pythonのlambdaと高階関数の活用入門
date: 2025-11-08
categories: [Python]
tags: [AI, Gemini, 自動生成, Python, lambdaと高階関数の活用]
---
...
# cat temp_output.json | jq -r '.response | fromjson.article_body' >> articles/python/10_lambdaと高階関数の活用.md
# rm temp_output.json
```
