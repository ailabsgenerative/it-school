---
title: Pythonのクラス定義とオブジェクト指向の基礎入門
date: 2025-11-08
categories: [Python]
...
# cat temp_output.json | jq -r '.response | fromjson.article_body' >> articles/python/16_クラス定義とオブジェクト指向の基礎.md
# rm temp_output.json
```
