---
title: Pythonのスクリプトの書き方とコメント／docstring入門
date: 2025-11-08
categories: [Python]
tags: [AI, Gemini, 自動生成, Python, スクリプトの書き方とコメント／docstring]
---
...
テーマ: Pythonのスクリプトの書き方とコメント／docstring
...
# cat temp_output.json | jq -r '.response | fromjson.article_body' >> articles/python/02_スクリプトの書き方とコメント_docstring.md
# rm temp_output.json
```
